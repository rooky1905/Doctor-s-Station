...
def showpres(request):
    ...
    return render(request,'prescriptions/showpres.html',{'pre':pre}) #passing all prescriptions as context dictionary..

@login_required #This for patient to see the prescription!
